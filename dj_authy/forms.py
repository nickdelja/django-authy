...
class BaseAuthyMediaForm(forms.ModelForm):
    ...
    class Media:
        css = {
            css = ('//cdnjs.cloudflare.com/ajax/libs/authy-form-helpers/2.3/form.authy.min.css',)
        }
        js = ('//cdnjs.cloudflare.com/ajax/libs/authy-form-helpers/2.3/form.authy.min.js',)
...
class AuthyRegisterForm(BaseAuthyMediaForm):
    ...
    is_smartphone = forms.BooleanField(help_text='', required=False, initial=True)
